...
let savedInfo = {
	itemsPosition : [
		{ id : 1, name : "Battery", file: "battery.png", active: false, x:0, y:0, found : false},
		{ id : 2, name : "Circuit", file: "circuit.png", active: false, x:0, y:0, found : false},
		{ id : 3, name : "Antena",  file: "antena.png",  active: false, x:0, y:0, found : false},
	],
	currentItem : null,
	currentOxygen : 10,
	currentPiecesNum: 0
...
SpaceLost = ig.Game.extend(
{
	...
	gameoverImg : new ig.Image('media/game_over.png'),
	congratsImg : new ig.Image('media/congrats.png'),
	...
	draw: function()
	{
		...
		if (!this.gameOver)
		{
			...
			this.font.draw( savedInfo.currentPiecesNum + ' / 3 COLLECTED PIECES', 115,32);
			...
			if (!this.winGame)
				this.gameoverImg.draw((ig.system.width / 2) - 265,(ig.system.height / 2) - 45);
		}
		...
		if (this.winGame)
		{
			...
			this.player.paused = true;
			//this.player.getDamaged();
			this.congratsImg.draw((ig.system.width / 2) - 265,(ig.system.height / 2) - 45);
		}
...
SplashState = ig.Class.extend(
{
	...
	font: new ig.Font( 'media/04b03.font.png', { borderColor: '#4A2559',
													borderSize:2,
													fontColor: '#FFF',
													letterSpacing : 2} ),
	counter : 0,
	...
	draw : function ()
	{
		...
		var x = (ig.system.width * 0.5) - 250;
		var y = ig.system.height - 80;

		if (Math.random() > 0.1)
		{
			this.font.draw('- Presiona X o ESPACIO para continuar', x, y);
		}
...
DialogSystem = ig.Class.extend(
{
	...
	keysSound : new ig.Sound('media/sfx/teclas.ogg'),
