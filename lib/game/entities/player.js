...
.defines(function()
{
    EntityPlayer = ig.Entity.extend(
    {
        ...
        shotSound : new ig.Sound('media/sfx/disparo.ogg'),
        ...
        init: function (x, y, settings)
        {
            ...
            ig.music.add( 'media/music/universo.ogg' );
            ig.music.volume = 0.3;
            ...
            if (ig.game.currentLevel == LevelExterior)
            {
                ...
                if ((savedInfo.itemsPosition[0].active
                    || savedInfo.itemsPosition[1].active
                    || savedInfo.itemsPosition[2].active) && savedInfo.currentItem != null  )
                    {
                        savedInfo.currentPiecesNum++;
                        this.releaseItem();

                        if (savedInfo.currentPiecesNum >= 3)
                        {
                            ig.game.winGame = true;
                            console.log("Mostrar mensaje felicitaciones");
                        }
                    }
        ...
        releaseItem : function ()
        {
            ...
            if (this.direction == "up")
                savedInfo.currentItem.pos.y = this.pos.y;
            else if (this.direction == "down")
                savedInfo.currentItem.pos.y = this.pos.y;
            if (this.direction == "left")
                savedInfo.currentItem.pos.x = this.pos.x;
            else if (this.direction == "right")
                savedInfo.currentItem.pos.x = this.pos.x;
